...
// 		$('input[name="r_cmtvalue"]').val(CKEDITOR.instances.editor1.getData());
		handling.submit( '', 'nonmbprivacyup' );
	}
</script>
		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<div class="">
					...
					<form action="nonmbprivacyup" class="form-horizontal" id="frm" name="frm" method="post" >
...
<!-- 						<input name="r_cmtvalue" type="hidden" />  -->
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									<div class="x_title">
										<h2>비회원 개인정보처리방침 관리<small>Persnal Infomation Securit Manage</small></h2>
