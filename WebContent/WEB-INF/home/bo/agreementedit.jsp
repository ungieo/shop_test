...
<!-- 						<input name="r_cmtvalue" type="hidden" />  -->
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									<div class="x_title">
										<h2>이용약관 정보 설정<small>Agreement Infomation Set</small></h2>
...
<%-- 												<textarea class="form-control" id="editor1" name="editor1" placeholder="${ model.commontext.CMT_NAME }">${ model.commontext.CMT_VALUE }</textarea> --%>
												<textarea class="form-control" id="r_cmtvalue" name="r_cmtvalue" placeholder="${ model.commontext.CMT_NAME }" rows="20">${ model.commontext.CMT_VALUE }</textarea>
											</div>
										</div>
