...
<%
    InputStream stream = new FileInputStream( new File( request.getServletContext().getRealPath( "/WEB-INF/system/prop/shopinfo.properties" ) ) );
		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<div class="">
					...
					<form action="infoin" class="form-horizontal" id="frm" name="frm" method="post">
					
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									<div class="x_title">
										<h2>쇼핑몰 정보 관리 <small>Shop Infomation Manage</small></h2>
...
<%-- 												<input class="form-control" name="biznum" placeholder="상품코드" type="text" value="<fmt:message bundle="${shopinfo}" key="shop.biznum"/>" /> --%>
												<input class="form-control" name="biznum" placeholder="상품코드" type="text" value="<%= Cvt.toStr( props.getProperty("biznum") ) %>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-sm-2 col-xs-12" for="name">상호</label>
											<div class="col-sm-3 col-xs-12">
												<input class="form-control" name="name" placeholder="상품코드" type="text" value="<%= Cvt.toStr( props.getProperty("name") ) %>" />
<%-- 												<input class="form-control" name="name" placeholder="상호" type="text" value="<fmt:message bundle="${shopinfo}" key="shop.name"/>" /> --%>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-sm-2 col-xs-12" for="ceoname">대표자 성명</label>
											<div class="col-sm-3 col-xs-12">
												<input class="form-control" name="ceoname" placeholder="상품코드" type="text" value="<%= Cvt.toStr( props.getProperty("ceoname") ) %>" />
<%-- 												<input class="form-control" name="ceoname" placeholder="대표자 성명" type="text" value="<fmt:message bundle="${shopinfo}" key="shop.ceoname"/>" /> --%>
											</div>
										</div>
										...
										<div class="form-group">
											<label class="control-label col-sm-2 col-xs-12" for="scrname">개인정보보호 책임자</label>
											<div class="col-sm-3 col-xs-12">
										...
										<div class="form-group">
											<label class="control-label col-sm-2 col-xs-12" for="scrdepart">책임자 부서</label>
											<div class="col-sm-3 col-xs-12">
										...
										<div class="form-group">
											<label class="control-label col-sm-2 col-xs-12" for="scrposition">책임자 지위</label>
											<div class="col-sm-3 col-xs-12">
										...
										<div class="form-group">
											<label class="control-label col-sm-2 col-xs-12" for="scrphone">책임자 연락처</label>
											<div class="col-sm-3 col-xs-12">
										...
										<div class="form-group">
											<label class="control-label col-sm-2 col-xs-12" for="scremail">책임자 이메일</label>
											<div class="col-sm-3 col-xs-12">
