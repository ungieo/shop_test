	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$('#frm').submit(function(event){
				if( 'boardarticleup' != $(this).attr('action') ){
					$(this).attr('enctype', '');
				}
			})
		})
                ...
                <div class="col-md-9">
                    <div class="box">
						<form action="boardarticleup" class="form-horizontal" id="frm" name="frm" method="post" enctype="multipart/form-data" >
							...
							<input id="r_bdabdid" name="r_bdabdid" type="hidden" value="${ param.r_bdabdid }"/>
							<input id="r_bdaseq" name="r_bdaseq" type="hidden" value="${ param.r_bdaseq }" />
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea id="editor1" name="editor1" >${ model.boardarticle.BDA_CONTENT }</textarea>
								</div>
							</div>
							<c:if test="${ 'Y' eq model.board.BD_FILEUSE }">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input id="r_bdafilenum" name="r_bdafilenum" placeholder="파일개수" class="form-control" type="file" value="${ model.boardarticle.BDA_FILENUM }" />
									</div>
								</div>
							</c:if>
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
								    <div class="btn-group">
								       <button type="button" class="btn btn-primary" onclick="dataUp();">등록</button>
