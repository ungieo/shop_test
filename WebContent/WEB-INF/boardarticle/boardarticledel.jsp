...
<body>
	...
	<form action="boardarticledel" method="post" name="frm">

		<fieldset>
			<legend>boardarticledel</legend>
			<p>
				<label for="r_bdaseq">아이디</label>
				<input name="r_bdaseq" type="text" value="" required />
			</p>
			<p>
				<label for="r_bdabdid">게시판아이디</label>
				<input name="r_bdabdid" type="text" value="" required />
			</p>
			<p>
				<label for="r_bdabdcseq">게시글분류</label>
				<input name="r_bdabdcseq" type="text" value="" />
			</p>
			<p>
				<label for="r_bdacontent">내용</label>
				<input name="r_bdacontent" type="text" value="" />
			</p>
			<p>
				<label for="r_bdafilenum">파일개수</label>
				<input name="r_bdafilenum" type="text" value="" />
			</p>
			<p>
				<label for="r_bdagroupnum">그룹번호</label>
				<input name="r_bdagroupnum" type="text" value="" />
			</p>
			<p>
				<label for="r_bdalevelnum">레벨번호</label>
				<input name="r_bdalevelnum" type="text" value="" />
			</p>
			<p>
				<label for="r_bdastepnum">스텝번호</label>
				<input name="r_bdastepnum" type="text" value="" />
			</p>
			<p>
				<label for="r_bdambid">작성자아이디</label>
				<input name="r_bdambid" type="text" value="" />
			</p>
			<p>
				<label for="r_bdaname">제목</label>
				<input name="r_bdaname" type="text" value="" />
			</p>
			<p>
				<label for="r_bdaownername">작성자명</label>
				<input name="r_bdaownername" type="text" value="" />
			</p>
			<p>
				<label for="r_bdapswd">비밀문자</label>
				<input name="r_bdapswd" type="text" value="" />
			</p>
			<p>
				<label for="r_bdareadcnt">조회수</label>
				<input name="r_bdareadcnt" type="text" value="" />
			</p>
			<p>
				<label for="r_bdarecommendcnt">추천수</label>
				<input name="r_bdarecommendcnt" type="text" value="" />
			</p>
			<p>
				<label for="r_bdastatus">상태값</label>
				<input name="r_bdastatus" type="text" value="" />
			</p>
			<p>
				<label for="r_bdalevel">레벨</label>
				<input name="r_bdalevel" type="text" value="" />
			</p>
			<p>
				<label for="r_bdatype">타입</label>
				<input name="r_bdatype" type="text" value="" />
			</p>
			<p>
				<label for="r_bdause">사용여부</label>
				<input name="r_bdause" type="text" value="" />
			</p>
			<p>
				<label for="r_bdamoid">수정아이디</label>
				<input name="r_bdamoid" type="text" value="" />
			</p>
			<p>
				<label for="r_bdainid">등록아이디</label>
				<input name="r_bdainid" type="text" value="" />
			</p>
			<!--<p>
				<label for="r_bdamodate">수정일</label>
				<input name="r_bdamodate" type="text" value="" required />
			</p>-->
			<!--<p>
				<label for="r_bdaindate">등록일</label>
				<input name="r_bdaindate" type="text" value="" required />
			</p>-->
