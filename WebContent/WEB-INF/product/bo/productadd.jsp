...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#frm').validate({
			rules: {
				r_prcode: { required: true }
				,r_prname:{ required: true }
				,r_prprice:{ required: true, digits: true }
				,r_primage1:{ required: true}
			},
		});
...
// 	var optionHtml = '';
// 	optionHtml += '<div class="form-group form-group-sm">';
// 	optionHtml += '	<label class="sr-only control-label col-sm-2 col-xs-12" for="r_progname">옵션등록</label>';
// 	optionHtml += '	<div class="col-sm-3 col-xs-12">';
// 	optionHtml += '		<input class="form-control" name="r_progname" placeholder="옵션그룹명 예)색상" type="text" />';
// 	optionHtml += '	</div>';
// 	optionHtml += '	<div class="col-sm-5 col-xs-12">';
// 	optionHtml += '		<input class="form-control" name="r_proname" placeholder="옵션명 예) 빨강,노랑,파랑,검정" type="text" />';
// 	optionHtml += '	</div>';
// 	optionHtml += '	<div class="col-sm-2 col-xs-12">';
// 	optionHtml += '		<button class="btn btn-sm btn-danger" type="button" onclick="optionDel(this)">삭제</button>';
// 	optionHtml += '	</div>';
// 	optionHtml += '</div>';
	
// 	function optionAdd(){
// 		$('#proption').append(optionHtml);
// 	}
											...
											<div class="col-sm-2 col-xs-12">
												<select class="form-control" id="ctgr1" name="ctgr1">
													...
													<c:forEach var="ctgr" items="${ model.productcategoryList }">
														<option value="${ ctgr.PRC_SEQ }">${ ctgr.PRC_NAME }</option>
													</c:forEach>
												</select>
											</div>
											<div class="col-sm-2 col-xs-12">
...
<!-- 										</div> -->
										...
										<div class="form-group">
											...
											<div class="col-sm-3 col-xs-12">
												<input class="form-control" id="r_primage1" name="r_primage1" placeholder="상품이미지1" type="file" accept="image/*" value="<c:out value='${ model.product.PR_IMAGE1 }' />" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-sm-2 col-xs-12" for="r_primage2">상품이미지2</label>
											<div class="col-sm-3 col-xs-12">
												<input class="form-control" id="r_primage2" name="r_primage2" placeholder="상품이미지2" type="file" accept="image/*" value="<c:out value='${ model.product.PR_IMAGE2 }' />" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-sm-2 col-xs-12" for="r_primage3">상품이미지3</label>
											<div class="col-sm-3 col-xs-12">
												<input class="form-control" id="r_primage3" name="r_primage3" placeholder="상품이미지3" type="file" accept="image/*" value="<c:out value='${ model.product.PR_IMAGE3 }' />" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-sm-2 col-xs-12" for="r_primage4">상품이미지4</label>
											<div class="col-sm-3 col-xs-12">
												<input class="form-control" id="r_primage1" name="r_primage4" placeholder="상품이미지4" type="file" accept="image/*" value="<c:out value='${ model.product.PR_IMAGE4 }' />" />
											</div>
										</div>
											...
											<div class="col-sm-3 col-xs-12">
												<select class="form-control" id="r_prcpids" name="r_prcpids" >
													...
													<c:forEach var="scompany" items="${ model.scompanyList }">
														<option value="${ scompany.CP_ID }">${ scompany.CP_NAME }</option>
													</c:forEach>
												</select>
											</div>
										</div>
...
<!-- 										</div> -->
										...
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-3 col-xs-12">
												<input class="form-control" name="r_progname" placeholder="옵션그룹명 예)색상" type="text" />
											</div>
											<div class="col-sm-7 col-xs-12">
												<input class="form-control" name="r_proname" placeholder="옵션명 예) 빨강,노랑,파랑,검정" type="text" />
											</div>
										</div>
										...
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-3 col-xs-12">
												<input class="form-control" name="r_prgprname1" id="r_prgprname1" placeholder="관련상품1" readonly="readonly" type="text" />
												<input type="hidden" name="r_prgprseq1" id="r_prgprseq1"/>
											</div>
										...
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-3 col-xs-12">
												<input class="form-control" name="r_prgprname2" id="r_prgprname2" placeholder="관련상품2" readonly="readonly" type="text" />
												<input type="hidden" name="r_prgprseq2" id="r_prgprseq2"/>
											</div>
											<div class="col-sm-2 col-xs-12">
												<button class="btn btn-sm btn-info" type="button" onclick="prgAdd(this);">상품검색</button>
												<button class="btn btn-sm btn-danger" type="button" onclick="prgDel(this);">삭제</button>
										...
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-3 col-xs-12">
												<input class="form-control" name="r_prgprname3" id="r_prgprname3" placeholder="관련상품3" readonly="readonly" type="text" />
												<input type="hidden" name="r_prgprseq3" id="r_prgprseq3"/>
											</div>
											<div class="col-sm-2 col-xs-12">
												<button class="btn btn-sm btn-info" type="button" onclick="prgAdd(this);">상품검색</button>
												<button class="btn btn-sm btn-danger" type="button" onclick="prgDel(this);">삭제</button>
										...
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-3 col-xs-12">
												<input class="form-control" name="r_prgprname4" id="r_prgprname4" placeholder="추천상품1" readonly="readonly" type="text" />
												<input type="hidden" name="r_prgprseq4" id="r_prgprseq4"/>
											</div>
											<div class="col-sm-2 col-xs-12">
												<button class="btn btn-sm btn-info" type="button" onclick="prgAdd(this);">상품검색</button>
												<button class="btn btn-sm btn-danger" type="button" onclick="prgDel(this);">삭제</button>
										...
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-3 col-xs-12">
												<input class="form-control" name="r_prgprname5" id="r_prgprname5" placeholder="추천상품2" readonly="readonly" type="text" />
												<input type="hidden" name="r_prgprseq5" id="r_prgprseq5"/>
											</div>
											<div class="col-sm-2 col-xs-12">
												<button class="btn btn-sm btn-info" type="button" onclick="prgAdd(this);">상품검색</button>
												<button class="btn btn-sm btn-danger" type="button" onclick="prgDel(this);">삭제</button>
										...
										<div class="form-group form-group-sm">
											...
											<div class="col-sm-3 col-xs-12">
												<input class="form-control" name="r_prgprname6" id="r_prgprname6" placeholder="추천상품3" readonly="readonly" type="text" />
												<input type="hidden" name="r_prgprseq6" id="r_prgprseq6"/>
											</div>
											<div class="col-sm-2 col-xs-12">
												<button class="btn btn-sm btn-info" type="button" onclick="prgAdd(this);">상품검색</button>
												<button class="btn btn-sm btn-danger" type="button" onclick="prgDel(this);">삭제</button>
...
<!-- 										<div class="form-group"> -->
<!-- 											<label class="control-label col-sm-2 col-xs-12" for="r_prweight">옵션등록</label> -->
<!-- 											<div class="col-sm-10 col-xs-12"> -->
<!-- 												<button class="btn btn-success" type="button" onclick="optionAdd();">옵션추가</button> -->
<!-- 											</div> -->
<!-- 										</div> -->
...
<!-- 										<div id="proption"></div> -->
										...
										<div class="form-group">
											...
											<div class="col-sm-10 col-xs-12">
												<input class="form-control" id="editor1" name="editor1" placeholder="내용" type="text" value="<c:out value='${ model.product.PR_CONTENT }' />" required />
											</div>
										</div>
										<div class="form-group">
...
<%-- 												<input class="form-control" id="r_prstatus" name="r_prstatus" placeholder="상품상태" type="text" value="<c:out value='${ model.product.PR_STATUS }' />" required /> --%>
												<label class="radio-inline">
													<input name="r_prstatus" placeholder="상품상태" type="radio" value="Y" checked="checked"/>YES
												</label>
												<label class="radio-inline">
													<input name="r_prstatus" placeholder="상품상태" type="radio" value="N" />NO
												</label>
											</div>
										</div>
										<div class="form-group">
...
<%-- 												<input class="form-control" id="r_prlevel" name="r_prlevel" placeholder="레벨" type="text" value="<c:out value='${ model.product.PR_LEVEL }' />" /> --%>
												<label class="radio-inline">
													<input name="r_prlevel" placeholder="상품레벨" type="radio" value="Y" checked="checked"/>Y
												</label>
											</div>
										</div>
										<div class="form-group">
...
<%-- 												<input class="form-control" id="r_prtype" name="r_prtype" placeholder="타입" type="text" value="<c:out value='${ model.product.PR_TYPE }' />" /> --%>
												<label class="radio-inline">
													<input name="r_prtype" placeholder="상품타입" type="radio" value="Y" checked="checked"/>Y
												</label>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10 col-xs-12">
												<label class="radio-inline">
													<input name="r_pruse" type="radio" value="Y" checked="checked"/>YES
												</label>
												<label class="radio-inline">
													<input name="r_pruse" type="radio" value="N" />NO
												</label>
											</div>
										</div>
<!-- 										</fieldset> -->
