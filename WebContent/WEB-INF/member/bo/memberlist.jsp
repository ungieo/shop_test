...
<script type="text/javascript">
	$(function(){
		...
		$('#datatable-responsive').DataTable({
			...
			"ajax": {
				"url" : "${cpath}/member/bo/memberlistjson",
			...
			"columns":[
				...
				{ 
					...
					"fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
			            $(nTd).html( '<a href="memberview?r_mbid='+oData.mb_id+'">'+oData.mb_id+'</a>');
			        }
		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<div class="">
					...
					<form action="memberlist" class="form-horizontal" id="frm" name="frm" method="post" >
					...
					<div class="row">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>회원 검색 <small>Member Search</small></h2>
...
<!--                        					</li> -->
					...
					<div class="row">					
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>회원리스트 <small>Member List</small></h2>
									<ul class="nav navbar-right panel_toolbox">
										<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
<!-- 										<li class="dropdown"> -->
<!-- 											<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-wrench"></i></a> -->
