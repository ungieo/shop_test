					...
					<div class="row">
						...
						<div class="col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										관리자 등록 <small>AdminMember Add</small>
									</h2>
								...
								<div class="x_content">
									...
									<form class="form-horizontal form-label-left" action="adminmemberin" method="post" name="frm" id="frm" >
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-3 col-xs-12">
												<input type="password" class="form-control" placeholder="비밀번호확인"  id="r_mbpswd" name="r_mbpswd" value="${ model.member.MB_PSWD }">
											</div>
										</div>
										<div class="form-group">
...
<%-- 												<input type="text" class="form-control" placeholder="부서코드" id="r_mbdpid" name="r_mbdpid" value="${ model.member.MB_DPID }"> --%>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-10 col-sm-10 col-xs-12">
												<label class="radio-inline"><input name="r_mbsex" type="radio" value="1" checked="checked"/>남성</label>
										...
										<div class="form-group">
											...
											<div class="col-md-10 col-sm-10 col-xs-12">
												<label class="radio-inline"><input name="r_mblevel" type="radio" value="N" checked="checked"/>일반</label>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10 col-sm-10 col-xs-12">
												<label class="radio-inline"><input name="r_mbtype" type="radio" value="N" checked="checked"/>일반</label>
												<label class="radio-inline"><input name="r_mbtype" type="radio" value="P" />구매사</label>
												<label class="radio-inline"><input name="r_mbtype" type="radio" value="S" />공급사</label>
												<label class="radio-inline"><input name="r_mbtype" type="radio" value="M" />관리자</label>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10 col-sm-10 col-xs-12">
												<label class="radio-inline"><input name="r_mbuse" type="radio" value="Y" checked="checked"/>YES</label>
												<label class="radio-inline"><input name="r_mbuse" type="radio" value="N" />NO</label>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="col-md-10 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-2">
												<button type="submit" class="btn btn-success btn-sm" onclick="dataIn()" ><i class="fa fa-save"></i> 저장</button>
