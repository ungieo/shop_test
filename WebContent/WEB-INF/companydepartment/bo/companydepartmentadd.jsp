									...
									<form action="companydepartmentin" class="form-horizontal" id="frm" name="frm" method="post" >
										...
										<fieldset>
												...
												<div class="col-sm-10">
													<select class="form-control" name="r_cpdcpid" >
														<c:forEach var="company" items="${ model.companyList }">
															<option value="${ company.CP_ID }" <c:if test="${ company.CP_ID eq param.r_cpid }">selected="selected"</c:if> >${ company.CP_NAME }</option>
														</c:forEach>
													</select>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<label class="radio-inline"><input name="r_cpduse" type="radio" value="Y" checked="checked" placeholder="승인여부"/>YES</label>
													<label class="radio-inline"><input name="r_cpduse" type="radio" value="N" placeholder="승인여부" />NO</label>
												</div>
											</div>
											<div class="form-group">
