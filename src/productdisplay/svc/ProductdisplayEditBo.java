...
public class ProductdisplayEditBo implements Svc{
	...
	public void handling( HttpServletRequest req, HttpServletResponse res, Map<String, Object> model ){
		...
		try{
			...
			Productdisplay productdisplay = productdisplayDao.one( sqlMap );
			wColNameList.clear();wColValList.clear();wColTypeList.clear();
			conn.commit();
			//--- Dao

			//---* model
			model.put( "productdisplay", productdisplay );
			model.put( "returnType", "F" );
			model.put( "returnPage", "/productdisplay/bo/productdisplayedit" );
			//---* model
