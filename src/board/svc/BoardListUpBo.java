...
public class BoardListUpBo implements Svc{
	...
	public void handling( HttpServletRequest req, HttpServletResponse res, Map<String, Object> model ){
		...
		try{
			...
			String r_bdidarr = Cvt.toStr( req.getParameter( "r_bdidarr" ) );
			...
			whereStr = " and BD_ID in ( "+r_bdidarr+" ) ";
			boardDao.upChoice( r_column, "'"+r_columnvalue+"'", whereStr );
			conn.commit();
			//--- Dao

			//---* model
			model.put( "returnType", "R" );
			model.put( "returnPage", "/board/bo/boardlist?r_page="+r_page );
			//--- model
