...
public class AdminMemberInBo implements Svc{
...
//			member.setMB_INDATE( r_mbindate );
			...
			model.put( "returnPage", "/member/bo/adminmemberview?r_mbid="+r_mbid );
			//--- model
