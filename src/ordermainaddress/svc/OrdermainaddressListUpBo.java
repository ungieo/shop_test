...
public class OrdermainaddressListUpBo implements Svc{
	...
	public void handling( HttpServletRequest req, HttpServletResponse res, Map<String, Object> model ){
		...
		try{
			...
			String r_omaseqarr = Cvt.toStr( req.getParameter( "r_omaseqarr" ) );
			...
			whereStr = " and OMA_SEQ in ( "+r_omaseqarr+" ) ";
			ordermainaddressDao.upChoice( r_column, "'"+r_columnvalue+"'", whereStr );
			...
			model.put( "returnPage", "/ordermainaddress/bo/ordermainaddresslist?r_page="+r_page );
			//--- model
