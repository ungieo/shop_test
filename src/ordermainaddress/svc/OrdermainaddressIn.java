...
public class OrdermainaddressIn implements Svc{
...
//			ordermainaddress.setOMA_INDATE( r_omaindate );
			...
			ordermainaddressDao.in( ordermainaddress );
			...
			model.put( "returnPage", "/ordermainaddress/ordermainaddressview?r_omaseq="+r_omaseq );
			//--- model
