...
public class OrdermainitemhistoryInBo implements Svc{
...
//			ordermainitemhistory.setOMIH_INDATE( r_omihindate );
			...
			ordermainitemhistoryDao.in( ordermainitemhistory );
			...
			model.put( "returnPage", "/ordermainitemhistory/bo/ordermainitemhistoryview?r_omihseq="+r_omihseq );
			//--- model
