...
public class OrdermainitemhistoryEditBo implements Svc{
	...
	public void handling( HttpServletRequest req, HttpServletResponse res, Map<String, Object> model ){
		...
		try{
			...
			//---* param
			String r_omihseq = Cvt.toStr( req.getParameter( "r_omihseq" ) );
			//--- param
			...
			Ordermainitemhistory ordermainitemhistory = ordermainitemhistoryDao.one( sqlMap );
			wColNameList.clear();wColValList.clear();wColTypeList.clear();
			conn.commit();
			//--- Dao

			//---* model
			model.put( "ordermainitemhistory", ordermainitemhistory );
			model.put( "returnType", "F" );
			model.put( "returnPage", "/ordermainitemhistory/bo/ordermainitemhistoryedit" );
			//---* model
