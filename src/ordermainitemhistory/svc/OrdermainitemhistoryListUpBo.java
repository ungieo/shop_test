...
public class OrdermainitemhistoryListUpBo implements Svc{
	...
	public void handling( HttpServletRequest req, HttpServletResponse res, Map<String, Object> model ){
		...
		try{
			...
			String r_omihseqarr = Cvt.toStr( req.getParameter( "r_omihseqarr" ) );
			...
			whereStr = " and OMIH_SEQ in ( "+r_omihseqarr+" ) ";
			ordermainitemhistoryDao.upChoice( r_column, "'"+r_columnvalue+"'", whereStr );
			...
			model.put( "returnPage", "/ordermainitemhistory/bo/ordermainitemhistorylist?r_page="+r_page );
			//--- model
