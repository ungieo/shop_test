...
public class ProductbasketEditBo implements Svc{
	...
	public void handling( HttpServletRequest req, HttpServletResponse res, Map<String, Object> model ){
		...
		try{
			...
			Productbasket productbasket = productbasketDao.one( sqlMap );
			wColNameList.clear();wColValList.clear();wColTypeList.clear();
			conn.commit();
			//--- Dao

			//---* model
			model.put( "productbasket", productbasket );
			model.put( "returnType", "F" );
			model.put( "returnPage", "/productbasket/bo/productbasketedit" );
			//---* model
