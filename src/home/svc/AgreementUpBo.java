...
public class AgreementUpBo implements Svc{
...
//			colNameList.add( " SHOP_AGREEMENT = ? ");colValList.add( r_shopagreement );colTypeList.add( "String");
...
//			shopinfoDao.upChoice(sqlMap);
			...
			model.put( "returnPage", "/home/bo/agreementedit" );
			//---* model
