...
public class OrdermainListUpBo implements Svc{
	...
	public void handling( HttpServletRequest req, HttpServletResponse res, Map<String, Object> model ){
		...
		try{
			...
			whereStr = " and OM_SEQ in ( "+r_omseqarr+" ) ";
			ordermainDao.upChoice( r_column, "'"+r_columnvalue+"'", whereStr );
			...
			model.put( "returnPage", "/ordermain/bo/ordermainlist?r_page="+r_page );
			//--- model
