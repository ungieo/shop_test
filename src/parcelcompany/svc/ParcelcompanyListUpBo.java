...
public class ParcelcompanyListUpBo implements Svc{
	...
	public void handling( HttpServletRequest req, HttpServletResponse res, Map<String, Object> model ){
		...
		try{
			...
			String r_pcseqarr = Cvt.toStr( req.getParameter( "r_pcseqarr" ) );
			...
			whereStr = " and PC_SEQ in ( "+r_pcseqarr+" ) ";
			parcelcompanyDao.upChoice( r_column, "'"+r_columnvalue+"'", whereStr );
