...
public class ProductcategoryUp implements Svc{
...
//			Timestamp r_prcindate =  req.getParameter( "r_prcindate") );
			...
			productcategory.setPRC_MOID( r_prcmoid );
...
//			productcategory.setPRC_INDATE(r_prcindate );
			...
			productcategoryDao.up( sqlMap );
			conn.commit();
			//--- Dao

			//---* model
			model.put( "returnType", "R" );
			model.put( "returnPage", "/productcategory/productcategoryview?r_prcseq="+r_prcseq );
			//--- model
