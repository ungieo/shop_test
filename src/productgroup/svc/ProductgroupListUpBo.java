...
public class ProductgroupListUpBo implements Svc{
	...
	public void handling( HttpServletRequest req, HttpServletResponse res, Map<String, Object> model ){
		...
		try{
			...
			String r_prgseqarr = Cvt.toStr( req.getParameter( "r_prgseqarr" ) );
			...
			whereStr = " and PRG_SEQ in ( "+r_prgseqarr+" ) ";
			productgroupDao.upChoice( r_column, "'"+r_columnvalue+"'", whereStr );
			...
			model.put( "returnPage", "/productgroup/bo/productgrouplist?r_page="+r_page );
			//--- model
