...
public class OrdermainitemaddressUp implements Svc{
...
//			ordermainitemaddress.setOMIA_INDATE(r_omiaindate );
			...
			ordermainitemaddressDao.up( sqlMap );
			...
			model.put( "returnPage", "/ordermainitemaddress/ordermainitemaddressview?r_omiaseq="+r_omiaseq );
			//--- model
