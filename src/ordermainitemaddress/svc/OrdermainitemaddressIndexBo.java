...
public class OrdermainitemaddressIndexBo implements Svc{
...
//			ordermainitemaddressDao.one( sqlMap );
			//--- Dao

			//---* model
			model.put( "returnType", "F" );
			model.put( "returnPage", "/ordermainitemaddress/bo/ordermainitemaddressindex" );
			//---* model
