...
public class OrdermainitemaddressListUpBo implements Svc{
	...
	public void handling( HttpServletRequest req, HttpServletResponse res, Map<String, Object> model ){
		...
		try{
			...
			String r_omiaseqarr = Cvt.toStr( req.getParameter( "r_omiaseqarr" ) );
			...
			whereStr = " and OMIA_SEQ in ( "+r_omiaseqarr+" ) ";
			ordermainitemaddressDao.upChoice( r_column, "'"+r_columnvalue+"'", whereStr );
			...
			model.put( "returnPage", "/ordermainitemaddress/bo/ordermainitemaddresslist?r_page="+r_page );
			//--- model
