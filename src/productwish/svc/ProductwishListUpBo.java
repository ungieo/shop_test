...
public class ProductwishListUpBo implements Svc{
	...
	public void handling( HttpServletRequest req, HttpServletResponse res, Map<String, Object> model ){
		...
		try{
			...
			String r_prwseqarr = Cvt.toStr( req.getParameter( "r_prwseqarr" ) );
			...
			whereStr = " and PRW_SEQ in ( "+r_prwseqarr+" ) ";
			productwishDao.upChoice( r_column, "'"+r_columnvalue+"'", whereStr );
			...
			model.put( "returnPage", "/productwish/bo/productwishlist?r_page="+r_page );
			//--- model
