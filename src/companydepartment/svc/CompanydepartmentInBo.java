...
public class CompanydepartmentInBo implements Svc{
...
//			companydepartment.setCPD_SEQ( r_cpdseq );
			...
			companydepartment.setCPD_MOID( ss_mbid );
			companydepartment.setCPD_INID( ss_mbid );
...
//			companydepartment.setCPD_INDATE( r_cpdindate );
			...
			companydepartmentDao.in( companydepartment );
			
			int r_cpdseq = companydepartmentDao.lastId();
			conn.commit();
			//--- Dao
